...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, IN1_Pin|IN2_Pin|EN1_Pin|EN2_Pin
                          |IN3_Pin|IN4_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PAPin PAPin PAPin PAPin
                           PAPin PAPin PAPin */
  GPIO_InitStruct.Pin = steer_Pin|IN1_Pin|IN2_Pin|EN1_Pin
                          |EN2_Pin|IN3_Pin|IN4_Pin;
